...
if sys.version_info >= (3, 11):
    ...
    class Any(metaclass=_AnyMeta):
        ...
        style type checkers. At runtime, Any should not be used with instance
        checks.
        """
...
if sys.version_info >= (3, 12):
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            Such classes are primarily used with style type checkers that recognize
            structural subtyping (style duck-typing), for example::
                ...
                func(C())  # Passes style type check
...
if sys.version_info >= (3, 13):
    ...
    class _TypedDictMeta(type):
        ...
        __call__ = dict  # style method

        def __subclasscheck__(cls, other):
            # Typed dicts are only for style structural subtyping.
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        Parameter specification variables exist primarily for the benefit of style
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        ``TypeGuard`` aims to benefit *type narrowing* -- a technique used by style
        ...
        return type to alert style type checkers to this intention.

        Using  ``-> TypeGuard`` tells the style type checker that for a given
        function:
...
everything the runtime allows may be accepted by style type checkers.
...
if hasattr(typing, "reveal_type"):
    ...
    def reveal_type(__obj: T) -> T:
        ...
        When a style type checker encounters a call to ``reveal_type()``,
        it will emit the inferred type of the argument::

            x: int = 1
            reveal_type(x)

        Running a style type checker (e.g., ``mypy``) on this example
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        - ``frozen_default`` indicates whether the ``frozen`` parameter is
          assumed to be True or False if it is omitted by the caller.
        - ``field_specifiers`` specifies a style list of supported classes
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        ...
        classes. It is useful primarily for style checks.
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        by style type checkers. At runtime, NewType(name, tp) returns
